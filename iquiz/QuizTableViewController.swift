...
class QuizTableViewController: UITableViewController {
    ...
    @IBAction func settingsButton(sender: UIBarButtonItem) {
        ...
        let pressAction = UIAlertAction(title: "Ok", style: .Default) { (action) -> Void in
            //println("The user is okay.")
        }
        
        

        alertController.addAction(pressAction)
...
override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("Cell", forIndexPath: indexPath) as! QuizTableViewCell
        
        
        cell.cellImage.image =  UIImage(named: "quizimage")
